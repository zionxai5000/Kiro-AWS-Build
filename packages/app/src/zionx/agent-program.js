...
exports.ZIONX_AGENT_PROGRAM = exports.ZIONX_COMPLETION_CONTRACTS = exports.ZIONX_STATE_MACHINE = void 0;
// ---------------------------------------------------------------------------
// ZionX State Machine Definition
// ---------------------------------------------------------------------------
exports.ZIONX_STATE_MACHINE = {
    ...
    metadata: {
        ...
        description: 'ZionX App Factory lifecycle state machine — manages apps from ideation through market research, store submission, review, live deployment, marketing, and revenue optimization.',
    },
};
// ---------------------------------------------------------------------------
// Completion Contracts
// ---------------------------------------------------------------------------
exports.ZIONX_COMPLETION_CONTRACTS = [
    {
...
exports.ZIONX_AGENT_PROGRAM = {
    ...
    stateMachine: exports.ZIONX_STATE_MACHINE,
    completionContracts: exports.ZIONX_COMPLETION_CONTRACTS,
    authorityLevel: 'L4',
    allowedActions: [
        'generate_code',
        'compile_app',
    ...
    changelog: [
        ...
        },
        {
            ...
            author: 'system',
            description: 'Added market-research, marketing, and revenue-optimizing states. Integrated full GTM engine with ASO, campaign management, landing pages, revenue optimization, and portfolio management.',
        },
    ],
};
