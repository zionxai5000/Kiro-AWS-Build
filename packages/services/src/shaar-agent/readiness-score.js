...
exports.ReadinessScoreCalculator = void 0;
class ReadinessScoreCalculator {
    history = { scores: [], improvements: [] };
    /**
    ...
    calculateTrend(currentScore) {
        if (this.history.scores.length < 2)
            return 'stable';
        const previous = this.history.scores[this.history.scores.length - 1].overall;
        if (currentScore > previous + 2)
            return 'improving';
        if (currentScore < previous - 2)
            return 'declining';
        return 'stable';
    }
    generateTopImprovements(dimensions, reports) {
        const improvements = [];
    ...
    getImprovementForDimension(dimension, reports) {
...
exports.ReadinessScoreCalculator = ReadinessScoreCalculator;
//# sourceMappingURL=readiness-score.js.map