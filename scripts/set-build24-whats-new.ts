...
const BUILD_ID = '10bfcd89-fb29-4f49-a774-7b06614e32e8';
const WHATS_NEW = 'Build #24 — Lotus icon renamed to FlowerLotus (correct phosphor v2.3 export). Onboarding should now render fully.';
...
(async () => {
  ...
  console.log('whatsNew applied to Build #24');
