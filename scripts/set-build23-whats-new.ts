...
const BUILD_ID = '56677acd-87a4-49f9-bb73-53ce4a769328';
const WHATS_NEW = 'Build #23 — Skia LinearGradient/vec imports replaced with expo-linear-gradient. Onboarding should now render. Sentry still capturing any new errors.';
...
(async () => {
  ...
  console.log('whatsNew applied to Build #23');
