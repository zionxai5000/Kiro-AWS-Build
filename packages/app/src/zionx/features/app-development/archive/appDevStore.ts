/**
 * ARCHIVED — Zustand store for the App Development feature.
 *
 * This file is archived because the architecture shifted from React Native
 * (Zustand + MMKV) to a backend orchestration pipeline (pure Node.js TypeScript).
 * Preserved for historical reference only.
 *
 * Original location: features/app-development/state/appDevStore.ts
 * Archived: 2026-05-13
 * Reason: Architecture amendment v2 — backend orchestration supersedes mobile framing.
 *
