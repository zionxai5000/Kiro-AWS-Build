...
export const ZXMG_STATE_MACHINE: StateMachineDefinition = {
  ...
  metadata: {
    ...
    description:
      'ZXMG Media Production lifecycle — manages content from planning through script generation, asset creation, video assembly, platform upload, and performance monitoring.',
  },
};
...
export const ZXMG_COMPLETION_CONTRACTS: CompletionContract[] = [
  {
...
export const ZXMG_AGENT_PROGRAM: AgentProgram = {
  ...
  stateMachine: ZXMG_STATE_MACHINE,
  completionContracts: ZXMG_COMPLETION_CONTRACTS,
