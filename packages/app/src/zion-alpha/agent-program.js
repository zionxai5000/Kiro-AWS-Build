...
exports.ZION_ALPHA_AGENT_PROGRAM = exports.ZION_ALPHA_COMPLETION_CONTRACTS = exports.ZION_ALPHA_STATE_MACHINE = void 0;
// ---------------------------------------------------------------------------
// Zion Alpha State Machine Definition
// ---------------------------------------------------------------------------
exports.ZION_ALPHA_STATE_MACHINE = {
    ...
    metadata: {
        ...
        description: 'Zion Alpha Trading lifecycle — manages trades from market scanning through evaluation, positioning, monitoring, and settlement.',
    },
};
// ---------------------------------------------------------------------------
// Completion Contracts
// ---------------------------------------------------------------------------
exports.ZION_ALPHA_COMPLETION_CONTRACTS = [
    {
...
// ---------------------------------------------------------------------------
exports.ZION_ALPHA_AGENT_PROGRAM = {
    ...
    stateMachine: exports.ZION_ALPHA_STATE_MACHINE,
    completionContracts: exports.ZION_ALPHA_COMPLETION_CONTRACTS,
    authorityLevel: 'L3',
    allowedActions: [
        'scan_markets',
